...
function Leads({name}){
  ...
  useEffect(() => {
    ...
    const leadArr = [person1, person2, person3, person4, person5,person6,person7,person8];
  ...
  return (
    <>
      <div className="body-home min-h-screen">
        <Sidebar name={name} page={page} setPage={setPage} />
        <div className="home-main ml-20p">
          <div className="date-container flex flex-col ">
            <div className="text-1.7xl text-right ml-4 ">
              {dateFormatted}
            </div>
...
function calculateDaysElapsed(date){
      ...
      let daysElapsed = (timeElapsed / 86400000);
